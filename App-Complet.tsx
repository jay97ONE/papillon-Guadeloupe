...
const HERO_IMAGE =
  'https://images.unsplash.com/photo-1758612120966-b20c01160c7b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsdXh1cnklMjBnYXJkZW4lMjBsYW5kc2NhcGUlMjBkZXNpZ258ZW58MXx8fHwxNzU4OTYwMzkxfDA&ixlib=rb-4.1.0&q=80&w=1080';
...
const PORTFOLIO_DATA = [
  {
    ...
    before:
      'https://images.unsplash.com/photo-1673370491774-42a963ca1ffd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxnYXJkZW4lMjBiZWZvcmUlMjBhZnRlciUyMHRyYW5zZm9ybWF0aW9ufGVufDF8fHx8MTc1ODk2MDQxMXww&ixlib=rb-4.1.0&q=80&w=1080',
    after:
      'https://images.unsplash.com/photo-1758812647166-6d4166137f19?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2Rlcm4lMjBnYXJkZW4lMjAzRCUyMGRlc2lnbnxlbnwxfHx8fDE3NTg5NjAzOTR8MA&ixlib=rb-4.1.0&q=80&w=1080',
    category: 'Particulier',
    location: 'Les Abymes',
    description:
      "Transformation complète d'un jardin résidentiel avec création d'espaces de vie extérieurs.",
  ...
  },
  {
    ...
    before:
      'https://images.unsplash.com/photo-1598693452686-a428df8f83cd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwcm9mZXNzaW9uYWwlMjBsYW5kc2NhcGUlMjBjb25zdWx0YXRpb258ZW58MXx8fHwxNzU4OTYwNDA3fDA&ixlib=rb-4.1.0&q=80&w=1080',
    after:
      'https://images.unsplash.com/photo-1640627349323-82aa2da94150?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0cm9waWNhbCUyMGdhcmRlbiUyMGd1YWRlbG91cGV8ZW58MXx8fHwxNzU4OTYwNDA0fDA&ixlib=rb-4.1.0&q=80&w=1080',
    category: 'Professionnel',
    location: 'Saint-François',
    description:
      "Aménagement paysager complet d'un complexe hôtelier 4 étoiles.",
  ...
  },
  {
    ...
    before:
      'https://images.unsplash.com/photo-1758435260100-0c7be32a97bf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsYW5kc2NhcGUlMjBhcmNoaXRlY3R1cmUlMjBwbGFubmluZ3xlbnwxfHx8fDE3NTg5NjA0MDB8MA&ixlib=rb-4.1.0&q=80&w=1080',
    after:
      'https://images.unsplash.com/photo-1758612120966-b20c01160c7b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsdXh1cnklMjBnYXJkZW4lMjBsYW5kc2NhcGUlMjBkZXNpZ258ZW58MXx8fHwxNzU4OTYwMzkxfDA&ixlib=rb-4.1.0&q=80&w=1080',
    category: 'Particulier',
    location: 'Gosier',
    description:
      "Création d'un jardin zen avec bassins et espaces de méditation.",
        ...
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Link
              to="/realisations"
              className={`hover:text-primary transition-colors ${
                isActive('/realisations') ? 'text-primary font-medium' : ''
              }`}
            >
              Réalisations
            </Link>
            <Link
              to="/processus"
              className={`hover:text-primary transition-colors ${
                isActive('/processus') ? 'text-primary font-medium' : ''
              }`}
            >
              Notre Processus
            </Link>
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-sm opacity-80">
                Architecte paysagiste en Guadeloupe, nous concevons des jardins
                d'exception parfaitement adaptés au climat tropical.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm opacity-80">
                ...
                <li>
                  <Link to="/processus" className="hover:opacity-100">
                    Notre processus
                  </Link>
                </li>
                <li>
          ...
          <div className="border-t border-white/20 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            <div className="text-sm opacity-80">
              © {new Date().getFullYear()} Papillon Guadeloupe Création. Tous
              droits réservés.
            </div>
  ...
  const testimonials = [
    {
      id: 1,
      quote:
        'Papillon Guadeloupe Création a transformé notre espace extérieur en véritable havre de paix. Leur expertise technique et leur créativité ont dépassé nos attentes.',
    ...
    },
    {
      id: 2,
      quote:
        "Collaboration parfaite pour l'aménagement de notre complexe hôtelier. Plans 3D précis, respect des délais et rendu exceptionnel.",
    ...
    },
    {
      id: 3,
      quote:
        "Service professionnel de A à Z. La visite conseil nous a permis d'optimiser notre budget et d'obtenir le jardin de nos rêves.",
  ...
  const highlights = [
    {
      ...
      description:
        'Connaissance approfondie de la flore et du climat guadeloupéen',
      icon: '🌺',
    },
    {
      title: 'Visualisation 3D',
      description:
        'Rendus photo-réalistes pour valider votre projet avant réalisation',
      icon: '🎨',
    },
    {
      title: 'Accompagnement Complet',
      description:
        'De la conception à la réalisation avec nos partenaires qualifiés',
      icon: '🤝',
    },
  ];
        ...
        <div className="relative container mx-auto px-6">
          <div className="max-w-4xl">
            <div className="mb-6">
              <Badge
                variant="secondary"
                className="mb-4 bg-green-600/20 text-white border-green-600/30"
              >
            ...
            <p className="text-xl text-white/90 mb-8 max-w-2xl">
              De la conception 3D à la réalisation, nous donnons vie à vos
              projets d'aménagement paysager avec l'expertise d'un climat
              tropical unique et la passion du détail.
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Nous combinons passion du paysagisme, expertise tropicale et
              technologies modernes pour créer des jardins d'exception.
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Particuliers ou professionnels, nous avons la solution
              vos besoins.
            </p>
          </div>
            ...
            <CardContent className="p-8">
              <div className="text-center">
                <div className="flex justify-center mb-4">
                  {[...Array(testimonials[testimonialsIndex].rating)].map(
                    (_, i) => (
                      <svg
                        key={i}
          ...
          <Card className="max-w-4xl mx-auto text-center bg-gradient-to-r from-green-600 to-green-700 text-white border-0">
            <CardContent className="p-12">
              ...
              <p className="text-xl mb-8 opacity-90">
                ...
                comment nous pouvons donner vie à vos projets d'aménagement
                paysager.
              </p>
  ...
  const servicesParticuliers = [
    {
      ...
      description:
        "Analyse de votre terrain et conseils d'experts pour optimiser votre aménagement paysager.",
    ...
    },
    {
      ...
      description:
        "Création d'un aménagement paysager sur mesure avec plans techniques et visualisations 3D.",
      price: 'Sur devis',
  ...
  const servicesProfessionnels = [
    {
      ...
      description:
        "Conception d'aménagements paysagers pour projets d'envergure.",
      price: 'Sur devis',
    ...
    },
    {
      ...
      description:
        "Suivi complet de vos projets d'aménagement, de la conception à la réalisation.",
      price: 'Sur devis',
      duration: 'Variable',
      includes: [
      ...
      <section className="py-20 bg-gradient-to-br from-green-50 to-blue-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Que vous soyez particulier ou professionnel, nous adaptons notre
              expertise à vos besoins spécifiques pour concevoir des jardins
              d'exception.
            </p>
          </div>
        </div>
          ...
          <Tabs defaultValue="particuliers" className="w-full">
            ...
            <TabsContent value="professionnels">
              <div className="text-center mb-12">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto">
                  Accompagnement technique et créatif pour vos projets
                  d'envergure.
                </p>
              </div>
              ...
              >
                <div className="relative h-64 bg-muted">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handlePortfolioSlide(idx, Number(e.target.value))
                    }
  ...
  const processSteps = [
    {
      ...
      description:
        'Questionnaire personnalisé, visite sur site et analyse des contraintes techniques.',
      details: [
    ...
    },
    {
      ...
      description:
        'Esquisse initiale, puis projet 3D complet avec possibilité de modifications.',
      details: [
    ...
    },
    {
      ...
      description:
        'Livraison des documents complets et accompagnement pour la réalisation.',
      details: [
      ...
      <section className="py-20 bg-gradient-to-br from-green-50 to-blue-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              De l'analyse initiale à la remise des documents finaux, nous vous
        ...
        <div className="container mx-auto px-6">
          <Card className="max-w-4xl mx-auto text-center bg-gradient-to-r from-green-600 to-green-700 text-white border-0">
            <CardContent className="p-12">
              ...
              <p className="text-xl mb-8 opacity-90">
                Notre processus éprouvé garantit un résultat à la hauteur de vos
                attentes.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" variant="secondary" asChild>
...
function ContactPage() {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    alert(
      'Merci ! Votre demande a été envoyée. Nous vous recontacterons dans les 24h.'
    );
    setFormData({
      name: '',
      email: '',
      ...
      <section className="py-20 bg-gradient-to-br from-green-50 to-blue-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Racontez-nous votre vision et recevez une proposition
          ...
          <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Plus votre demande est détaillée, plus notre proposition sera
                  précise.
                </CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      ...
                      >
                        ...
                        <SelectContent>
                          <SelectItem value="visite-conseil">
                            Visite conseil (particulier)
                          </SelectItem>
                          <SelectItem value="conception-3d">
                            Conception complète 3D
                          </SelectItem>
                          <SelectItem value="etude-professionnelle">
                            Étude paysagère (professionnel)
                          </SelectItem>
                          <SelectItem value="maitrise-oeuvre">
                            Maîtrise d'œuvre
                          </SelectItem>
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-muted-foreground">
                          Connaissance approfondie du climat
                        </div>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
...
export function ImageWithFallback({
  src,
  fallbackSrc = 'https://via.placeholder.com/600x400?text=Image+indisponible',
  alt,
  ...props
